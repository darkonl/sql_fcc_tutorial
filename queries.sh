...
echo "$($PSQL "SELECT DISTINCT(teams.name) FROM teams INNER JOIN games ON teams.team_id=games.winner_id OR teams.team_id=games.opponent_id WHERE teams.name LIKE 'Co%' ORDER BY teams.name")"
